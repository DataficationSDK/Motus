...
/// <summary>
/// Tools for mocking requests on the active context: answering them with a canned response,
/// blocking them, or letting them through with overrides applied. A rule applies to every tab
/// in the active context and survives navigation.
/// </summary>
/// <remarks>
...
/// thrown. Patterns are matched as an exact string, a glob when they contain <c>*</c>, or a
/// substring otherwise.
/// </remarks>
[McpServerToolType]
